...
public class GraphBuildingHandler extends DefaultHandler {
    ...
    private ArrayList<Long> tempRoad;
    private boolean validRoad, oneway;
...
//            System.out.println("Node lat: " + attributes.getValue("lat"));
            ...
            g.addNode(currentNodeID, lon, lat);
...
//            System.out.println("Beginning a way...");
            ...
            long road_id = Long.parseLong(attributes.getValue("ref"));
            tempRoad.add(road_id);
...
//            System.out.println("Tag with k=" + k + ", v=" + v + ".");
            ...
            String v = GraphDB.cleanString(attributes.getValue("v"));

            g.addLocation(currentNodeID, v, attributes.getValue("v"));
...
//            System.out.println("Node's name: " + attributes.getValue("v"));
    ...
    public void endElement(String uri, String localName, String qName) throws SAXException {
        if (qName.equals("way") && validRoad) {
            /* We are done looking at a way. (We finished looking at the nodes, speeds, etc...)*/
            /* Hint1: If you have stored the possible connections for this way, here's your
            chance to actually connect the nodes together if the way is valid. */
//            System.out.println("Finishing a way...");
            for (int i = 1; i < tempRoad.size(); i++) {
                g.addEdge(tempRoad.get(i - 1), tempRoad.get(i), oneway);
            }
        }
    }
